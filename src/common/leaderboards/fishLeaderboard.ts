...
export async function handleFish(
    ...
    if (metric === "top") {
        ...
        return { formattedLeaderboard, metricDisplay: "most valuable fish", leaderboardType: "Fish", order };
    }
    ...
    return { formattedLeaderboard, metricDisplay, leaderboardType: "Fish", order };
}
